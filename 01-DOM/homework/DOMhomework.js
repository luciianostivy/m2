...
// Tu código acá:
var creador = document.querySelector('#cratedBy'); // numeral o punto para cada cosa (id o elemento)
creador.innerHTML +=  ' Luciano Esquivel'; 
...
function displayToDos() {
  // Tu código acá:
  var toDoContainer = document.querySelector('#toDoContainer'); //document es el html, query es la funcion y lo que esta entre parentesis es lo que queremos buscar
...
// Tu código acá:
let boton = document.querySelector('#addButon'); //agregamos el boton
boton.addEventListener('click', addToDo); //agreamos un evento, se lee cada vez que se haga click hace algo en este caso addtodo
